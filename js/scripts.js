$(document).ready(function(){
  $(".quiz").submit(function(event) {
    ...
    $(".name").text(name);
      ...
      if (goalsInput === "Select from below" || experienceInput === "Select from below" || movieInput === "Select from below" || liveInput === "Select from below" || pirateInput === "Select from below"){
        $("#no").fadeToggle();
      } else {
